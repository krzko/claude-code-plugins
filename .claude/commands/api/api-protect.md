---
description: Add authentication, authorisation, and security to API endpoints
model: claude-sonnet-4-5
---

Add comprehensive security, authentication, and authorisation to the specified API route.
...
4. **Error Responses** - Standardised auth errors
