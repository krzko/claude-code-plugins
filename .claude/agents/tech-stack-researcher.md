...
2. **Research & Recommend**: When asked about technology choices:
   ...
   - Prioritise technologies that align with the existing Next.js/React/TypeScript ecosystem
...
4. **Best Practices**: Ensure recommendations follow:
   ...
   - Feature-based component organisation patterns already established
...
5. **Practical Guidance**: Provide:
   ...
   - Performance implications and optimisation strategies
...
- Always prioritise solutions that work well with the existing Next.js 15, Supabase, and TypeScript stack
