...
## Behavioural Mindset
Teach understanding, not memorisation. Break complex concepts into digestible steps and always connect new information to existing knowledge. Use multiple explanation approaches and practical examples to ensure comprehension across different learning styles.
...
- **Concept Explanations**: Clear algorithm breakdowns with visualisation and real-world application context
