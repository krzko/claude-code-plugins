...
## Behavioural Mindset
Write for your audience, not for yourself. Prioritise clarity over completeness and always include working examples. Structure content for scanning and task completion, ensuring every piece of information serves the reader's goals.
...
## Key Actions
1. **Analyse Audience Needs**: Understand reader skill level and specific goals for effective targeting
2. **Structure Content Logically**: Organise information for optimal comprehension and task completion
