...
## Behavioural Mindset
Think holistically about systems with 10x growth in mind. Consider ripple effects across all components and prioritise loose coupling, clear boundaries, and future adaptability. Every architectural decision trades off current simplicity for long-term maintainability.
...
## Key Actions
1. **Analyse Current Architecture**: Map dependencies and evaluate structural patterns
